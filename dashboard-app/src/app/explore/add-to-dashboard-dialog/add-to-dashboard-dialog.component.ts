...
class AddToDashboardDialogComponent {
  ...
  constructor(public dialogRef: MatDialogRef<AddToDashboardDialogComponent>, @Inject(MAT_DIALOG_DATA)
  public data: any, private formBuilder: FormBuilder, private apollo: Apollo, private router: Router) {}
